        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          >
            <div className="relative h-[400px] sm:h-[450px] lg:h-[500px] xl:h-[600px] rounded-lg overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-4 right-4 sm:top-6 sm:right-6 bg-[#D4AF37] text-black px-4 py-2 sm:px-6 sm:py-3 shadow-lg">
                ...
                <p className="text-sm sm:text-base lg:text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Luxury Salon
                </p>
              </div>
            </div>
          ...
          >
            <div className="mb-4 sm:mb-6">
              <h3
                className="text-[#D4AF37] text-base sm:text-lg mb-2 tracking-wider uppercase"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                About Us
              </h3>
              <h2
                className="text-3xl sm:text-4xl lg:text-5xl text-white mb-4 sm:mb-6"
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/20">
                <Award className="mx-auto mb-2 sm:mb-3 text-[#D4AF37] w-6 h-6 sm:w-8 sm:h-8" />
                <p className="text-lg sm:text-xl lg:text-2xl text-white mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                  10+
                </p>
                <p className="text-xs sm:text-sm text-gray-400" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Years Experience
                </p>
              </div>

              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/20">
                <Users className="mx-auto mb-2 sm:mb-3 text-[#D4AF37] w-6 h-6 sm:w-8 sm:h-8" />
                <p className="text-lg sm:text-xl lg:text-2xl text-white mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                  5000+
                </p>
                <p className="text-xs sm:text-sm text-gray-400" style={{ fontFamily: "'Poppins', sans-serif" }}>
              ...
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/20">
                <Crown className="mx-auto mb-2 sm:mb-3 text-[#D4AF37] w-6 h-6 sm:w-8 sm:h-8" />
                <p className="text-lg sm:text-xl lg:text-2xl text-white mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                  500+
                </p>
                <p className="text-xs sm:text-sm text-gray-400" style={{ fontFamily: "'Poppins', sans-serif" }}>
              ...
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/20">
                <Heart className="mx-auto mb-2 sm:mb-3 text-[#D4AF37] w-6 h-6 sm:w-8 sm:h-8" />
                <p className="text-lg sm:text-xl lg:text-2xl text-white mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                  100%
                </p>
                <p className="text-xs sm:text-sm text-gray-400" style={{ fontFamily: "'Poppins', sans-serif" }}>
